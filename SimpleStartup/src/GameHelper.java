...
//            System.out.println("Trying: " + Arrays.toString(startupCoords)); // comment this
...
//        System.out.println("Placed at: " + alphaCells); // comment this
    ...
    private boolean coordsAvailable(int[] startupCoords) {
        for (int coord : startupCoords) {
            if (grid[coord] != 0) {
//                System.out.println("position: " + coord + " already taken."); // comment this
                return false;
            }
        }
        return true;
